        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                     ...
                     Your task is to present a summary of a given book title along with the author's name. \
                     The author name may or may not be given. Note that the user may have given an imaginary title. \
                     If so, suggest the right title and request them to check the title once again."
                },
            ...
            response_format={
                "type": "json_schema",  "json_schema": {
                    "name": "BookBiteModel",
                    "schema": BookBiteModel.model_json_schema()
                }
            },
            temperature=0
            )
