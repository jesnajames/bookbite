...
# happy_path - test_get_book_summary_valid_title_author - Test that get_book_summary returns a valid BookBiteModel with correct title and author
def test_get_book_summary_valid_title_author(book_summarizer, mock_openai, book_bite_model):
    mock_openai.chat.completions.create.return_value.choices[0].message.content = json.dumps(book_bite_model.dict())
